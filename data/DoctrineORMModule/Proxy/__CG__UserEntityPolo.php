 ...
 */
class Polo extends \User\Entity\Polo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cidade', 'estado', 'dateCreated', 'status', 'dateUpdated', '' . "\0" . 'User\\Entity\\Polo' . "\0" . 'code'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Polo $proxy) {
