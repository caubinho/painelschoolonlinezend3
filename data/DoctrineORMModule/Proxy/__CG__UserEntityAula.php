 ...
 */
class Aula extends \User\Entity\Aula implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'titulo', 'file', 'slug', 'status', 'createdAt', 'updatedAt', 'tipo', 'texto', '' . "\0" . 'User\\Entity\\Aula' . "\0" . 'code', 'cronograma'];
        }
