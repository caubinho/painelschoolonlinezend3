...
class MaterialController extends AbstractActionController
{
    ...
    public function newAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
                ...
                if ($form->isValid()) {
                    ...
                    $dados['link'] = 'http://'.$_SERVER['HTTP_HOST'].'/material/'. $dados['file'];
    ...
    public function deleteAction()
    {
        ...
        $anexo = $this->checaAnexo('Material', $id);
        ...
        if(empty($anexo)) {
            ...
            $this->flashMessenger()->addErrorMessage('Não foi possível excluir existe(m) aulas com este material anexado!');
            return $this->redirect()->toRoute($this->route, ['controller' => $this->controller]);
